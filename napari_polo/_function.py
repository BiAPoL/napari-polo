...
@time_slicer
def generate_clean_orientation_image(raw_orientation_image: 'napari.types.ImageData', step_size: int = 10, erosion_footprint_width: int = 3) -> 'napari.types.LabelsData':
    
    from .utilities import prepro_orientation
    from .core_functions import percentile_pairs, filter_arr_vals, label_expansion
